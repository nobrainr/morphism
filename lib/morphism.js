 ...
 * @param  {Map<string, any>} schema Configuration of how properties are computed from the source
 * @param  {} items
 * @param  {} type
 */
...
class _Morphism {
     ...
     * @returns {Function} Mapper function to be used against a data source
     */
