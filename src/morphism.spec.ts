  ...
  describe("Schema", function() {
    describe("Action Selector", () => {
      it("should accept a selector action in deep nested schema property", () => {
        ...
        const aggregator: ActionAggregator<Source> = [
          "keySource",
          "keySource1"
        ];
      ...
      it("should throw an exception when a schema property is an empty object", () => {
        ...
        expect(() => {
          ...
          `A value of a schema property can't be an empty object. Value {} found for property prop`
        );
      });
    ...
    describe("Function Predicate", function() {
      ...
      it("should support nesting mapping", function() {
        ...
        let schema = {
          complexTarget: ({ complexSource }: any) =>
            Morphism(nestedSchema, complexSource)
        };
        let mock = {
          complexSource: {
            source: "value1",
